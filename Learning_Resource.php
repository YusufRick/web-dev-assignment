...
?>
    <h1 class="banner">Learning Resoursce</h1> 


     <div>
        <h1 class="Rules">Rules Governing the Use of the Resource Services </h1>
     </div>
     ...
     <div class="main">
        ...
        <div class="container4">
            ...
            <div>
                <h3 class="second">B. Use Of Facilities:</h3>
                <div class="section2">
